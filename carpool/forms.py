...
from carpool.models import UserProfile
...
class RegistrationForm(forms.Form):
    ...
    NID=forms.CharField(widget=forms.TextInput(attrs=dict(required=True,max_length=30,render_value=False)),label=_("NID"))
